...
def index(request):
    return render(request, "company/templates/company/base.html")


def list_dep(request):
    dep_list = Department.objects.all()
    return render(request, 'company/templates/company/dep_list.html', {'dep_list': dep_list})
...
def add_dep(request):
    if request.method == 'POST':
        ...
        if name.strip() == "":
            return render(request, "company/templates/company/dep_list.html", {"error": "部门名称不能为空"})
        try:
            ...
            logger.error(e)
            return render(request, "company/templates/company/dep_list.html", {"error": "部门创建失败"})
        else:
            return redirect("/company/list_dep/")
    return render(request, "company/templates/company/dep_add.html")
...
def edit_dep(request, dep_id):
    ...
    if request.method == 'POST':
        ...
        return render(request, "company/templates/company/dep_edit.html", {"dep": dep})


def list_group(request):
    group_list = Group.objects.all()
    return render(request, 'company/templates/company/group_list.html', {'group_list': group_list})
...
def add_group(request):
    if request.method == 'POST':
        ...
        script = request.POST.get("script")
        if name.strip() == "":
            return render(request, "company/templates/company/group_list.html", {"error": "小组名称不能为空"})
        try:
            ...
            logger.error(e)
            return render(request, "company/templates/company/group_list.html", {"error": "小组创建失败"})
        else:
            return redirect("/company/list_group/")
    return render(request, "company/templates/company/group_add.html")
...
def edit_group(request, group_id):
    if request.method == 'POST':
        ...
        group = Group.objects.get(id=group_id)
        return render(request, "company/templates/company/group_edit.html", {"group": group})


def list_employee(request):
    employee_list = Employee.objects.all()
    return render(request, 'company/templates/company/list_employee.html', {'employee_list': employee_list})
...
def add_employee(request):
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, "company/templates/company/employee_add.html", {"group_list": group_list, "dep_list": dep_list,
...
def edit_employee(request, employee_id):
    ...
    if request.method == 'POST':
        ...
        dep_list = Department.objects.all()
        employeeinfo_list = Employee.objects.all()
        return render(request, "company/templates/company/employee_edit.html", {"group_list": group_list, "dep_list": dep_list,
                                                             "employeeinfo_list": employeeinfo_list,
                                                             "employee": employee})
...
def list_employeeinfo(request):
    ...
    return render(request, 'company/templates/company/employeeinfo_edit.html', {'employeeinfo_list': employeeinfo_list})
...
def add_employeeinfo(request):
    if request.method == 'POST':
        ...
        try:
            ...
            logger.error(e)
            return render(request, "company/templates/company/employeeinfo_list.html", {"error": "员工信息创建失败"})
        else:
            return redirect("/company/list_employeeinfo/")
    return render(request, "company/templates/company/employeeinfo_add.html")
...
def edit_employeeinfo(request, employeeinfo_id):
    ...
    if request.method == 'POST':
        ...
        return render(request, "company/templates/company/employeeinfo_edit.html", {"employeeinfo": employeeinfo})
...
def test_forms(request):
    ...
    return render(request, "company/templates/company/test_form.html", {"test_form": test_form})
